/*｜by Akawatav｜jfunction｜v1.0.5｜関数追加するだけ｜*/
...
const get = {
    ...
    circle: radius => (radius ** 2) * get.pi,
    queryall: name => document.querySelectorAll(name),
    query: name => document.querySelector(name)
}
const query = {
...
const factorial = {
 ...
 double : n => (2 ** (n/2)) * factorial.none(n/2)
}
const parse = str => (str == 'true') ? true : false
const pass = function(){}
const customselector = value => value2 => {
